...
RegisterNetEvent("TW-CluckingBell:OpenTray", function(data)
...
RegisterNetEvent('TW-CluckingBell:OpenShop', function()
	QBCore.Functions.TriggerCallback('TW-CluckingBell:CheckDuty', function(result)
		if result then
...
RegisterNetEvent('TW-CluckingBell:SyncTable', function(CurrentVehicles)
	Config.ActiveVehicles = CurrentVehicles
end)

RegisterNetEvent("TW-CluckingBell:Sit", function(data)
	QBCore.Functions.TriggerCallback('TW-CluckingBell:GetPlace', function(Occupied)
		if Occupied then
			...
			TriggerServerEvent('TW-CluckingBell:TakePlace', data.pos.x, data.pos.y, data.pos.z)
			...
			Citizen.CreateThread(function()
				while true do
					...
					if IsControlJustReleased(0, 177) then
						...
						TriggerServerEvent('TW-CluckingBell:LeavePlace', data.pos.x, data.pos.y, data.pos.z)
						TriggerServerEvent("TW-CluckingBell:CheckSit:Server:SetSitActive", false)
...
RegisterNetEvent("TW-CluckingBell:MakeDrink", function(data)
    QBCore.Functions.TriggerCallback('TW-CluckingBell:HasItem', function(result)
        if result then
            ...
            QBCore.Functions.Progressbar("make_"..data.drink, Config.Locals["Progressbar"]["MakeDrinks"]["Text"] .. data.drinkname .. "...", Config.Locals["Progressbar"]["MakeDrinks"]["Time"], false, true, {
                ...
                TriggerServerEvent("TW-CluckingBell:RemoveItem", data.cuptype, 1)
                TriggerServerEvent("TW-CluckingBell:AddItem", data.drink, 1)
...
RegisterNetEvent("TW-CluckingBell:Grab", function(data)
    QBCore.Functions.Progressbar("grab_"..data.item, "Grabing " ..data.itemname .. "...", data.time, false, true, {
        ...
        TriggerServerEvent("TW-CluckingBell:AddItem", data.item, 1)
...
RegisterNetEvent("TW-CluckingBell:Drink", function(item, itemname, anim, animdict, model, bones, coords, thirst, cold, coffee)
	QBCore.Functions.Progressbar("drinking_"..item, Config.Locals["Progressbar"]["Drink"]["Text"] .. itemname .. "...", Config.Locals["Progressbar"]["Drink"]["Time"], false, true, {
		...
		TriggerServerEvent("TW-CluckingBell:RemoveItem", item, 1)
...
RegisterNetEvent("TW-CluckingBell:Eat", function(gumball, item, itemname, time, hunger, anim, animdict, model, bones, coords)
	if not gumball then
...
RegisterNetEvent("TW-CluckingBell:Make", function(data)
	QBCore.Functions.TriggerCallback('TW-CluckingBell:CheckFor'..data.event..'Items', function(HasItems)
		if HasItems then
			QBCore.Functions.Progressbar("make", "Making "..data.itemname .. "...", data.time, false, true, {
				...
				if data.item3 then
					TriggerServerEvent("TW-CluckingBell:RemoveItem", data.item3, 1)
				end
				if data.item4 then
					TriggerServerEvent("TW-CluckingBell:RemoveItem", data.item4, 1)
				end
				if data.item5 then
					TriggerServerEvent("TW-CluckingBell:RemoveItem", data.item5, 1)
				end
				TriggerServerEvent("TW-CluckingBell:RemoveItem", data.item1, 1)
				TriggerServerEvent("TW-CluckingBell:RemoveItem", data.item2, 1)
				TriggerServerEvent("TW-CluckingBell:AddItem", data.recieveitem, data.number)
...
CreateThread(function()
	exports[Config.Target]:AddBoxZone("Duty", vector3(Config.Locations["Duty"]["Coords"].x, Config.Locations["Duty"]["Coords"].y, Config.Locations["Duty"]["Coords"].z), 1.8, 0.34, {
		...
		maxZ = Config.Locations["Duty"]["maxZ"],
			...
			{
				type = "client",
				event = "TW-CluckingBell:DutyMenu",
	...
	for k, v in pairs(Config.Locations["Trays"]) do
        exports[Config.Target]:AddBoxZone("Tray"..k, vector3(v.coords.x, v.coords.y, v.coords.z), v.poly1, v.poly2, {
            ...
            maxZ = v.maxZ,
                ...
                {
                    type = "client",
					event = "TW-CluckingBell:OpenTray",
	...
	exports[Config.Target]:AddBoxZone("Shop", vector3(Config.Locations["Shop"]["Coords"].x, Config.Locations["Shop"]["Coords"].y, Config.Locations["Shop"]["Coords"].z), 1.8, 0.34, {
		...
		maxZ = Config.Locations["Shop"]["maxZ"],
			...
			{
				type = "client",
				event = "TW-CluckingBell:OpenShop",
	...
	exports[Config.Target]:AddTargetModel(688554878, {	
		...
		options = {
			{
				type = "client",
				event = "TW-CluckingBell:MakeDrink",
	...
	exports[Config.Target]:AddBoxZone("SodaMachine", vector3(Config.Locations["SodaMachine"]["Coords"].x, Config.Locations["SodaMachine"]["Coords"].y, Config.Locations["SodaMachine"]["Coords"].z), 1.6, 1.6, {
		...
		maxZ = Config.Locations["SodaMachine"]["maxZ"],
			...
			{
				type = "client",
				event = "TW-CluckingBell:SodaMenu",
	...
	exports[Config.Target]:AddBoxZone("CookingStation", vector3(Config.Locations["CookingStation"]["Coords"].x, Config.Locations["CookingStation"]["Coords"].y, Config.Locations["CookingStation"]["Coords"].z), 1.6, 1.6, {
		...
		maxZ = Config.Locations["CookingStation"]["maxZ"],
			...
			{
				type = "client",
				event = "TW-CluckingBell:CookingStationMenu",
	...
	for k, v in pairs(Config.Locations["Bill"]) do
		...
		options = {
			{
            	type = "client",
            	event ="TW-CluckingBell:Client:Biller",
                label = "Bill",
				job = Config.Job,
			},
		},
...
----Menus
----------------
RegisterNetEvent('TW-CluckingBell:Client:Biller', function()
    if Config.JimPayments then
        ...
        if dialog then
            ...
            TriggerServerEvent("TW-CluckingBell:Server:Billing", dialog.id, dialog.amount)
        end
    end
end)


RegisterNetEvent('TW-CluckingBell:Client:Notify')
AddEventHandler("TW-CluckingBell:Client:Notify", function(msg,type)
    Notify(msg,type)
end)

RegisterNetEvent("TW-CluckingBell:DutyMenu", function()
    local DutyMenu = {
        {
...
RegisterNetEvent("TW-CluckingBell:SodaMenu", function()
	QBCore.Functions.TriggerCallback('TW-CluckingBell:CheckDuty', function(result)
        if result then
			local SodaMenu = {
				{
...
RegisterNetEvent("TW-CluckingBell:CookingStationMenu", function()
	QBCore.Functions.TriggerCallback('TW-CluckingBell:CheckDuty', function(result)
        if result then
